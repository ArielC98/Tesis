...
export const createPDF = (role, data) => {
        ...
        content: [
            ...
            {text: `Paralelo: ${secretario}`, style:"info",bold:true, alignment:"center"},
            {
                ...
                table: {
                    ...
                    // keepWithHeaderRows: 1,
                    body: [
                        [{text: role ==="teacher"?"Estudiante":"Asignatura", style: 'header', rowSpan:2, margin:[0,16]},{text: 'Quimestre 1', style: 'header', colSpan: 4, fillColor: "#a01d27", color:"white"}, {},{},{}, {text: 'Quimestre 2', colSpan:4,style: 'header', fillColor: "#a01d27", color:"white"}, {},{},{},{text:'Periodo 2023-2024', style:'header',colSpan:4},{},{},{}],
